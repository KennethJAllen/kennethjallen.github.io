...
Applies CUR decomposition to dynamic mode decomposition, extracting dominant spatiotemporal modes from high-dimensional time-series data more efficiently than SVD-based approaches.
